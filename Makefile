...
.PHONY: docs-serve docs-clean build
...
test-cov: ## Run tests with coverage report
	@PYTHONDONTWRITEBYTECODE=1 $(UV) run --no-sync pytest --cov=src/litestar_oauth --cov-report=html --cov-report=term
